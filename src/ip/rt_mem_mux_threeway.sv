module rt_mem_mux_threeway #(
  ...
  input  logic                 c_gnt_i,
  input  logic                 c_rvalid_i,
  output logic                 c_we_o,
  output logic [StrbWidth-1:0] c_be_o,
  output logic [AddrWidth-1:0] c_addr_o,
  output logic [DataWidth-1:0] c_wdata_o,
  input  logic [DataWidth-1:0] c_rdata_i
);
  ...
  begin : mux
    ...
    case (select)
      ...
      2'b11: begin
        ...
        c_be_o       = cpu_be_i;
        c_addr_o     = cpu_addr_i;
        c_wdata_o    = cpu_wdata_i;
        cpu_rdata_o  = c_rdata_i;
        cpu_gnt_o    = c_gnt_i;
        cpu_rvalid_o = c_rvalid_i;
      end
      default: begin
        // nothing
      end
