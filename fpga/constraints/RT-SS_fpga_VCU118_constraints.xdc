# ------------------------------------------------------------------------------
# RT-SS_fpga_VCU118_constraints.xdc
#
# Author(s): Tom Szymkowiak <thomas.szymkowiak@tuni.fi>
# Date     : 16-feb-2024
# 
# Project: RT-SS
# Board  : AMD-Xilinx VCU118
# Notes  : 
# ------------------------------------------------------------------------------
...
# Main clock (top_clock) derived from clock wizard IP constraints, no definition required
...
set_output_delay -clock jtag_tck             4.000 [get_ports jtag_td_o];
...
## CLK -------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN AY24 IOSTANDARD LVDS} [get_ports clk_p_i]; # "CLK_125MHZ_P"
set_property -dict {PACKAGE_PIN AY23 IOSTANDARD LVDS} [get_ports clk_n_i]; # "CLK_125MHZ_N"

## RESET -----------------------------------------------------------------------
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS12} [get_ports rst_i]; # "CPU_RESET"
...
## GPIO ------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN BE23  IOSTANDARD LVCMOS18} [get_ports gpio_input_i[0]  ]; # "PUSH_BTN SW9 - EAST"
set_property -dict {PACKAGE_PIN BD23  IOSTANDARD LVCMOS18} [get_ports gpio_input_i[1]  ]; # "PUSH_BTN SW7 - CENTRAL"
set_property -dict {PACKAGE_PIN BF22  IOSTANDARD LVCMOS18} [get_ports gpio_input_i[2]  ]; # "PUSH_BTN SW6 - WEST"
set_property -dict {PACKAGE_PIN BE22  IOSTANDARD LVCMOS18} [get_ports gpio_input_i[3]  ]; # "PUSH_BTN SW12 - SOUTH"
set_property -dict {PACKAGE_PIN AT32  IOSTANDARD LVCMOS12} [get_ports gpio_output_o[0] ]; # "GPIO_LED 0"
set_property -dict {PACKAGE_PIN AV34  IOSTANDARD LVCMOS12} [get_ports gpio_output_o[1] ]; # "GPIO_LED 1"
set_property -dict {PACKAGE_PIN AY30  IOSTANDARD LVCMOS12} [get_ports gpio_output_o[2] ]; # "GPIO_LED 2"
set_property -dict {PACKAGE_PIN BB32  IOSTANDARD LVCMOS12} [get_ports gpio_output_o[3] ]; # "GPIO_LED 3"
