# ------------------------------------------------------------------------------
# RT-SS_fpga_PYNQZ1_constraints.xdc
#
...
## JTAG ------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN Y7  IOSTANDARD LVCMOS33} [get_ports jtag_tck_i  ]; #IO_L13P_T2_MRCC_13 Sch=ck_io[37]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports jtag_td_i   ]; #IO_L5P_T0_34 Sch=ck_io[0]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports jtag_td_o   ]; #IO_L2N_T0_34 Sch=ck_io[1]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports jtag_tms_i  ]; #IO_L3N_T0_DQS_34 Sch=ck_io[3]
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS33} [get_ports jtag_trst_ni]; #IO_L7P_T1_AD2P_35 Sch=sw[1]

## UART
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports uart_rx_i ]; #IO_L23N_T3_34 Sch=ck_io[12]
