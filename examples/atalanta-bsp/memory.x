...
PROVIDE(_start_TqFull_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqNotFull_trap = _start_DefaultHandler_trap);
...
PROVIDE(_start_TqId0_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqId1_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqId2_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqId3_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqId4_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqId5_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqId6_trap = _start_DefaultHandler_trap);
PROVIDE(_start_TqId7_trap = _start_DefaultHandler_trap);
